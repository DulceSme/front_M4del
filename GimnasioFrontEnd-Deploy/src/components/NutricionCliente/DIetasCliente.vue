<template>
    <!-- component -->
    <body class="bg-gray-700 text-charcoal font-sans leading-normal overflow-x-hidden lg:overflow-auto">
      <main class="flex-1 w-[70%] flex flex-col">
      <section class="bg-gray-400 p-4 shadow">
      <div class="md:flex">
